...
function Marker(poiData) {
    ...
    */
    ...
    this.markerDrawable_idle = new AR.ImageDrawable(markerImageResource, 5, {
        zOrder: 0,
        opacity: 1.0,
        /*
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(markerImageResource, 5, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });
	...
	//this.markerImageResource = new AR.ImageResource(poiData.image);
