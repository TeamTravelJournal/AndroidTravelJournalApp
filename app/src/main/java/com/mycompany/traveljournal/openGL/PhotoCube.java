...
public class PhotoCube {
    ...
    public void setImages(String postId){
        if(postId.equals("mrIbrgdKzR"))
        {
            resourceIds[0] = R.drawable.colora;
            resourceIds[1] = R.drawable.colorb;
            resourceIds[2] = R.drawable.colorc;
            resourceIds[3] = R.drawable.colord;
            resourceIds[4] = R.drawable.colore;
            resourceIds[5] = R.drawable.colorf;
        }
    }
